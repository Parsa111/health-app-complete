    ...
    <section className="py-24 bg-background">
      <div className="container mx-auto px-6">
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl hero-gradient p-12 md:p-16 lg:p-20"
        >
          {/* Background Pattern */}
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            >
              Join thousands of satisfied clients who have achieved their wellness goals 
              with our personalized programs. Start your journey today.
            </motion.p>
